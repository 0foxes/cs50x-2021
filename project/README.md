# snakewhisper
![GitHub release (latest by date)](https://img.shields.io/github/v/release//snakewhisper?style=flat-square)
![PyPI](https://img.shields.io/pypi/v/snakewhisper?style=flat-square)
![GitHub](https://img.shields.io/github/license//snakewhisper?style=flat-square)
...
### Git
```bash
$ git clone https://github.com//snakewhisper.git
$ cd snakewhisper
...
## License
snakewhisper is licenced under version 3.0 of the [GNU Affero General Public License](https://github.com//snakewhisper/blob/main/LICENSE).
