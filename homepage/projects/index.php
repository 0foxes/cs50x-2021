...
<body>
    <div class="container">
        ...
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <span>14 projects retrieved. These are just a few of my projects—all of the other ones are available on my <a href="https://github.com/">Github</a>.</span>
            ...
            <?php
                ...
                <div class="col-sm-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title text-center">.com</h4>
                        ...
                        <div class="modal fade" id="modalFour" tabindex="-1" aria-labelledby="modalFourLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title" id="modalFourLabel">.com</h3>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                ...
                <div class="col-sm-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="https://github.com//stonktrack">
                                <i class="fas fa-external-link-alt fa-2x px-2 icon float-end"></i>
                            </a>
                        </div>
                ...
                <div class="col-sm-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="https://github.com//simple-markov-flask">
                                <i class="fas fa-external-link-alt fa-2x px-2 icon float-end"></i>
                            </a>
                        </div>
                        <div class="modal fade" id="modalThirteen" tabindex="-1" aria-labelledby="modalThirteenLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>A Flask frontend for the <a href="https://github.com//simple-markov">simple-markov</a> script, it seamlessly integrates an HTML/JS/CSS frontend with the original C++ program serving as the backend. It also uses hCAPTCHA to prevent Denial of Service attacks while still respecting users' privacy. It's hosted on this site <a href="https://.com/apps/markov/">here</a>, and users can upload custom text training data to test it.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
